...
/***/ "./source/js/modules/full-page-animation.js":
/*!**************************************************!*\
  !*** ./source/js/modules/full-page-animation.js ***!
  \**************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return FullPageAnimation; });
...
// story page
const sliderTitleAnimation = new _accent_typography_build__WEBPACK_IMPORTED_MODULE_0__["default"]({
  element: document.querySelector(`.slider__item-title`),
  duration: 300,
});

// prize page
const prizesTitleAnimation = new _accent_typography_build__WEBPACK_IMPORTED_MODULE_0__["default"]({
  element: document.querySelector(`.prizes__title`),
  duration: 300,
});

// rules page
const rulesTitleAnimation = new _accent_typography_build__WEBPACK_IMPORTED_MODULE_0__["default"]({
  element: document.querySelector(`.rules__title`),
  duration: 300,
});

// game page
const gameTitleAnimation = new _accent_typography_build__WEBPACK_IMPORTED_MODULE_0__["default"]({
  element: document.querySelector(`.game__title`),
  duration: 300,
});

class FullPageAnimation {
  constructor() {
...
class FullPageScroll {
  ...
  onUrlHashChanged() {
    this.leavingScreen = this.activeScreen;
  ...
  changeVisibilityDisplay() {
    // story screen --> prizes screen
    const isFillScreen = this.leavingScreen === 1 && this.activeScreen === 2;
    ...
    if (isFillScreen) {
      this.screenElements[this.leavingScreen].classList.remove('screen--hidden');
      this.screenElements[this.leavingScreen].classList.add('screen--leaving');

      setTimeout(() => {
        this.screenElements[this.leavingScreen].classList.remove('screen--leaving');
        this.screenElements[this.leavingScreen].classList.add('screen--hidden');
...
/* harmony import */ var _modules_full_page_animation__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/full-page-animation */ "./source/js/modules/full-page-animation.js");
...
Object(_modules_common__WEBPACK_IMPORTED_MODULE_10__["default"])();

const fullPageScroll = new _modules_full_page_scroll__WEBPACK_IMPORTED_MODULE_8__["default"]();
fullPageScroll.init();

const fullPageAnimation = new _modules_full_page_animation__WEBPACK_IMPORTED_MODULE_9__["default"]();
